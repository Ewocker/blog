...
Left-to-right flow: messy notes on a small desk with a cat paw placing a note → 
glowing brain-chip hybrid (half neural network, half circuit board) in center → 
clean browser window showing a formatted blog post with email notification icon.
Messy colorful streams flow into the AI, clean organized streams flow out.
Dark navy background, purple/teal/amber accent glows. Minimal flat illustration.
...
A floating document page with faint Chinese text, being scanned by a purple-teal light beam.
Around it, 4 small minimal data visualizations: emoji bar chart, connector word donut chart,
punctuation ratio "1:11" comparison, and a 4-layer closing structure diagram.
Light gray background, clean analytical mood. Minimal flat illustration style.
No readable text. 1200x858, JPEG q80, <200KB.
-->
::
